...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/background_location/background_location.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/telephony/telephony.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/workmanager_apple/workmanager_apple.framework"
fi
