...
#ifndef BACKGROUND_LOCATION_SWIFT_H
#define BACKGROUND_LOCATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="background_location",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC19background_location29SwiftBackgroundLocationPlugin")
@interface SwiftBackgroundLocationPlugin : NSObject <CLLocationManagerDelegate, FlutterPlugin>
