...
#ifndef WORKMANAGER_APPLE_SWIFT_H
#define WORKMANAGER_APPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="workmanager_apple",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17workmanager_apple17WorkmanagerPlugin")
@interface WorkmanagerPlugin : FlutterPluginAppLifeCycleDelegate <FlutterPlugin>
+ (void)registerPeriodicTaskWithIdentifier:(NSString * _Nonnull)identifier frequency:(NSNumber * _Nullable)frequency;
+ (void)registerBGProcessingTaskWithIdentifier:(NSString * _Nonnull)identifier;
+ (void)setPluginRegistrantCallback:(FlutterPluginRegistrantCallback _Nonnull)callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIApplication;
@interface WorkmanagerPlugin (SWIFT_EXTENSION(workmanager_apple))
